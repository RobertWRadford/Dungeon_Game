					...
					if move == "6":
						...
						while loop == 2:
							if move == "8":
								...
								loop+=1
								move = input("\nCurious about the ringing noise you've been hearing you head back to where you came from and follow the noise. Cautiously sneaking past the burrow the rat emerged from earlier you notice the corpse of the rat looks much less feral than before, almost friendly and well groomed.... Making it back to where the cave seems to have given in you look at the pile of boulders and rocks, and hear that low ringing thunderously rolling out from the cracks. Do you begin digging out rocks or turn away?\n\n8.) Dig\n6.) Turn away\n\n")
								while loop == 3:
									if move == "8":
										loop+=1
										...
										print("\nFeeling invigorated you confidently walk into the next passageway, noting along the way the statue in the waters from before is missing now.\n")
										cavern2NoIllusions(Stats, curHealth, curStam, StamBar)
									elif move == "6":
										print("\nListening to the resonating sound calling out for you from under the rubble you stop and decide maybe you would be better off leaving it in its place. You rest for a moment and then head back the clearing and into the caverns ahead.\n")
										loop+=1
										(curHealth, curStam) = restRecovery(Stats, curHealth, curStam, StamBar)
								...
								loop+=1
								print("\nYou decide to continue your path down the next passageway, but before setting down it decide that you should first rest and tend to your wound a little.\n")
								(curHealth, curStam) = restRecovery(Stats, curHealth, curStam, StamBar)
								print("\nFeeling at least a little bit better you pick yourself up and slowly progress into the next passageway.\n")
								cavern2Disillusioned(Stats, curHealth, curStam, StamBar)
							else:
								move = input("please answer '8', '6', or '4'\n\n") 
					else:
										...
										if curHealth == 0:
											...
											while loop == 2:
												if choice == "8":
													...
													loop+=1
													print("\nYou take your time to position your footing and joints to make one swift push forward and stab into the shadow without alerting the shadow itself. YO \n")
												elif choice == "4":
													loop+=1
													print("\nyo\n")
												else:
